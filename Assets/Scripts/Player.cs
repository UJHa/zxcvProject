...
public class Player : Character
{
    void Start()
    {
        ...
        _moveSet.RegisterAction(eState.DAMAGED_AIRBORNE, KeyCode.None, eState.AIRBORNE_DAMAGED, new ActionInfo("Animation/DamageAir_Fall", 0f, 1f, AttackRangeType.NONE, 0.0f, 1.0f, AttackType.NONE));
        _moveSet.RegisterAction(eState.DAMAGED_LANDING, KeyCode.None, eState.DAMAGED_AIRBORNE, new ActionInfo("Animation/DamageAir_End_Light", 0f, 1f, AttackRangeType.NONE, 0.0f, 1.0f, AttackType.NONE));
