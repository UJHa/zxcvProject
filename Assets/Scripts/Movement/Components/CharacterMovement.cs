...
namespace ECM.Components
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        public void DetectGroundCustom()
        {
            // Reset 'grounding' info
            ...
            float deceleration, float friction, float brakingFriction)
        {
            ...
            if (!slideOnSteepSlope || groundAngle < slopeLimit)
            {
                ...
                Debug.Log($"[testMovement]v({v})vLength({v.magnitude})");
                velocity = v;
            }
            else
            {
        ...
        public void SnapToGround()
        {
            ...
            if (isOnLedgeSolidSide)
                distanceToGround = Mathf.Max(0.0f, Vector3.Dot(transform.position - groundPoint, transform.up));
        ...
        public void SnapToPlatform(ref Vector3 probingPosition, ref Quaternion probingRotation)
        {
